...
<center>
<footer>
<a href="{{route('inicio3')}}" class="button">🠔 Anterior pagina</a>
&nbsp
&nbsp
<a href="{{route('inicio5')}}" class="button">Siguiente pagina ➜</a>
</footer>
</center>
</section>
@endsection
...
<a href="" class="image featured"><img src="images/meek.gif" alt="" /></a>
<header>
	<h2><a href="{{route('inicio')}}">Rick and Morty</a></h2>
	<p>
	RECOMENDACION: Capitulo 24 "Mr Meeseeks"
	</p>
</header>
</article></div>
@endsection